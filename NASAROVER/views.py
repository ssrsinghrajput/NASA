...
from forms import GridForm, RoverForm, RoverSensor, mineral, rovermovement, roverupdate
...
def movementstring(request):
    if(request.method == 'POST'):
        ...
        if(form.is_valid()):
            ...
            model1.direct = d
            model1.save()
            string1 = "Final Grid points are " + str(x) +  " and " + str(y) + " with direction "+d 
